...
import {
  View, Text, StyleSheet, Slider, Button, Image
} from 'react-native';
...
Narrow down whats important to you when it comes to choosing a course.
            </Text>
          </View>
        );
      } else if (card === 'costs') {
...
Adjust the slider if you want to be more acurate
            </Text>
          </View>
        );
